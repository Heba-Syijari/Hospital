                ...
                <Col xl={1} lg={0} md={0}sm={0}> </Col>
                    ...
                    <Col xl={5} lg={6} md={6} sm={12} className="mb-5 pb-5 mid ">
                        <Form className="backwhite p-5 mb-5">
                            ...
                            <div className="font">Type your email to send the code</div>
                            <Form.Group controlId="formBasicEmail">
                                <Form.Label className="label mt-5">Email</Form.Label>
                            ...
                            <div className="d-grid gap-2">
                                <button className="btn text-white btn-primary mt-5 mb-1" type="button"><a href="Forgot_pass1">Send code</a></button>
                            </div>
